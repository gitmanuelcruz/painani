...
;(function($) {
    ...
    $.fn.jAlert = function(options) {
        ...
        var themes = ['default', 'green', 'verde', 'dark_green', 'red', 'dark_red', 'black', 'brown', 'gray', 'dark_gray', 'blue', 'dark_blue', 'yellow'],
        ...
        if( alert.type == 'confirm' )
        {
            ...
            alert.btns = [
                ...
                { 'text': alert.confirmBtnText, 'theme': 'verde', 'class': 'confirmBtn', 'closeAlert': true, 'onClick': alert.onConfirm },
