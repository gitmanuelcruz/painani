...
function getUnique(arr, name, multiselection) {
    ...
    return allItems.filter(function (item, i, array) { return array.indexOf(item) === i; }).sort();
}
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22), __webpack_require__(64).setImmediate))
...
var ts_message_1 = __webpack_require__(51);
...
function getCustomContentCell(cell, column, config, rowName, css, colIndex, rowIndex) {
    ...
    var getAriaAttrs = function (col, ind) { return ({
        role: "gridcell",
        "aria-colindex": ind,
    }); };
    ...
    return dom_1.el(".dhx_grid-" + rowName + "-cell.dhx_grid-custom-content-cell." + type, __assign(__assign({ class: css, style: {
        ...
        }, dhx_id: column.id }, getHandlers(column, rowName, config)), getAriaAttrs(column, colIndex)), [
        content &&
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22), __webpack_require__(66)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var html_1 = __webpack_require__(2);
var ts_grid_1 = __webpack_require__(72);
...
var Calendar = /** @class */ (function (_super) {
    ...
    Calendar.prototype._drawCalendar = function () {
        ...
        return dom_1.el("div", __assign({ class: widgetClass, style: {
            ...
            dom_1.el(".dhx_calendar__wrapper", [
                this._drawHeader(dom_1.el("button.dhx_calendar-action__show-month.dhx_button.dhx_button--view_link.dhx_button--size_small.dhx_button--color_secondary.dhx_button--circle", { "aria-live": "polite" }, date_1.locale.months[date.getMonth()] + " " + date.getFullYear())),
    ...
    Calendar.prototype._drawMonthSelector = function () {
        ...
        return dom_1.el("div", __assign({ class: widgetClass, style: {
            ...
            dom_1.el(".dhx_calendar__wrapper", [
                this._drawHeader(dom_1.el("button.dhx_calendar-action__show-year.dhx_button.dhx_button--view_link.dhx_button--size_small.dhx_button--color_secondary.dhx_button--circle", { "aria-live": "polite" }, date.getFullYear())),
    ...
    Calendar.prototype._drawYearSelector = function () {
        ...
        return dom_1.el("div", __assign({ class: widgetClass, style: { width: weekNumbers ? "calc(" + width + " + 48px)" : width } }, this._handlers), [
            dom_1.el(".dhx_calendar__wrapper", [
                this._drawHeader(dom_1.el("button.dhx_button.dhx_button--view_link.dhx_button--size_small.dhx_button--color_secondary.dhx_button--circle", { "aria-live": "polite" }, yearsDiapason[0] + "-" + yearsDiapason[yearsDiapason.length - 1])),
...
Object.defineProperty(exports, "__esModule", { value: true });
var Layout_1 = __webpack_require__(36);
...
var ProList = /** @class */ (function (_super) {
    ...
    ProList.prototype.showItem = function (id) {
        ...
        var listEl = this.getRootNode().getElementsByClassName("scroll-view")[0];
        if (!listEl) {
            return;
        }
        var virtual = this.config.virtual;
        ...
        comboFilter: {
            ...
            match: function (value, match) {
                ...
                if (Array.isArray(match)) {
                    match = match.join(", ");
                    return match && match.length ? match.includes(value) || value.includes(match) : true;
                }
                else {
...
Object.defineProperty(exports, "__esModule", { value: true });
var Grid_1 = __webpack_require__(33);
var types_1 = __webpack_require__(3);
var ts_data_1 = __webpack_require__(5);
var html_1 = __webpack_require__(2);
var data_1 = __webpack_require__(10);
...
var html_1 = __webpack_require__(2);
var ts_message_1 = __webpack_require__(51);
var ts_navbar_1 = __webpack_require__(54);
