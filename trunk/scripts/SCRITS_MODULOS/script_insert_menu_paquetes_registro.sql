...
VALUES
(NEXTVAL('seq_menus'),(SELECT id_menu FROM menus WHERE codigo_menu = 'PRIV_REG_PAQUETES'),'PRIV_BTN_NVO_NOTIFICACION','Botón para registrar nueva notificación',
'Botón para registrar nueva notificación','PRIVILEGIO','#','',1,10,'PRIV_ESPECIFICOS'),
(NEXTVAL('seq_menus'),(SELECT id_menu FROM menus WHERE codigo_menu = 'PRIV_REG_PAQUETES'),'PRIV_BTN_EDI_NOTIFICACION','Botón para editar registro de notificación',
'Botón para editar registro de notificación','PRIVILEGIO','#','',1,11,'PRIV_ESPECIFICOS'),
(NEXTVAL('seq_menus'),(SELECT id_menu FROM menus WHERE codigo_menu = 'PRIV_REG_PAQUETES'),'PRIV_BTN_CANL_NOTIFICACION','Botón para cancelar registro de notificación',
'Botón para cancelar registro de notificación','PRIVILEGIO','#','',1,12,'PRIV_ESPECIFICOS');
